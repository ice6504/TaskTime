      ...
      <div className="flex justify-between items-center">
        <div className="flex gap-8">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-xl font-bold text-white">{formatDate(today)}</p>
          </div>
          {/* People */}
          <div className="flex flex-col items-center gap-2">
            <p className="text-md font-medium">PROJECT MEMBERS</p>
            {/* Member */}
            <div className="w-fit cursor-pointer active:scale-90 avatar-group -space-x-4 rtl:space-x-reverse flex justify-center transition-all duration-100">
